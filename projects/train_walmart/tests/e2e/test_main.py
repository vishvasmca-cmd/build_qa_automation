...
def take_screenshot(page, name):
    ...
    path = os.path.join('projects/train_walmart/screenshots', f'{name}.png')
...
def test_autonomous_flow(page: Page):
    ...
    # Generated for train_walmart
    page.goto("https://www.walmart.com/")
    smart_action(page, "page.locator('section').get_by_text(\"Shop now\")", "click", None)
    take_screenshot(page, "step_0")
    expect(page).to_have_url("https://www.walmart.com/")
    smart_action(page, "page.locator('section').get_by_text(\"Shop now\")", "click", None)
    take_screenshot(page, "step_1")
    expect(page).to_have_url("https://www.walmart.com/")
    smart_action(page, "page.locator('section a:has-text(\"Shop now\")')", "click", None)
    take_screenshot(page, "step_2")
    expect(page).to_have_url("https://www.walmart.com/")
    page.locator("scroll").evaluate("node => node.scrollBy(0, 1000)")
