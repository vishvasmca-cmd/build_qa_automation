...
def take_screenshot(page, name):
    ...
    path = os.path.join('projects/train_netlify/screenshots', f'{name}.png')
...
def test_autonomous_flow(page: Page):
    ...
    # Generated for train_netlify
    page.goto("https://www.netlify.com/")
    smart_action(page, "section.n-page-section >> a:has-text('Get started')", "click", None)
    take_screenshot(page, "step_0")
    expect(page).to_have_url("https://www.netlify.com/")
    smart_action(page, "section.n-page-section >> a:has-text('Get started')", "click", None)
    take_screenshot(page, "step_1")
    expect(page).to_have_url("https://www.netlify.com/")
    smart_action(page, "nav#site-nav >> a[href='https://app.netlify.com/signup']", "click", None)
