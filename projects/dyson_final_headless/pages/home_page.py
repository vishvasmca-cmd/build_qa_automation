...
class HomePage:
    ...
    def Dyson Logo(self):
        ...
        return self.page.css=a[aria-label='Homepage'].or_(self.page.css=svg[class='dyson-logo'])
    ...
    def Cart Icon(self):
        ...
        return self.page.css=a[aria-label='Basket'].or_(self.page.css=div[class*='minicart'])
