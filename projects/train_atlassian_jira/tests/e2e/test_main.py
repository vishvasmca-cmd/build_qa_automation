...
def take_screenshot(page, name):
    ...
    path = os.path.join('projects/train_atlassian_jira/screenshots', f'{name}.png')
...
def test_autonomous_flow(page: Page):
    ...
    # Generated for train_atlassian_jira
    page.goto("https://www.atlassian.com/software/jira")
    smart_action(page, "nav._1e0c1txw >> a[href='/try/cloud/signup?bundle=jira-software&edition=free']", "click", None)
    take_screenshot(page, "step_0")
    expect(page).to_have_url("https://www.atlassian.com/software/jira")
    smart_action(page, "nav._1e0c1txw >> a[href='/try/cloud/signup?bundle=jira-software&edition=free']", "click", None)
    take_screenshot(page, "step_1")
    expect(page).to_have_url("https://www.atlassian.com/software/jira")
    smart_action(page, "main#content >> a[href='/try/cloud/signup?bundle=jira-software']", "click", None)
    ...
    expect(page).to_have_url("https://www.atlassian.com/software/jira")
    smart_action(page, "scroll", "click", None)
