...
Goal: Login with Admin/admin123 and find the PIM module
"""
import re
...
def test_minimal_smoke(browser: Browser):
    ...
    # 2. Navigate to site
    print(f"[Minimal Test] Navigating to https://opensource-demo.orangehrmlive.com/")
    ...
    assert "https://opensource-demo.orangehrmlive.com/" in current_url or page_title, \
    ...
    take_screenshot(page, "smoke_test_final", "verify_custom_orangehrm")
