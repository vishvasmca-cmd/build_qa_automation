...
class AutomationPracticePage:
    ...
    def Radio Button 1(self):
        ...
        return self.page.radio1.or_(self.page.css=input[value='radio1'])
    ...
    def Checkbox Option 1(self):
        ...
        return self.page.name=checkBoxOption1.or_(self.page.css=#checkBoxOption1)
    ...
    async def verify_loaded(self):
        ...
        await The 'Suggestion Class Example' input field is present