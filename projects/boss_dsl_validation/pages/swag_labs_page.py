...
class SwagLabsPage:
    ...
    def username_input(self):
        ...
        return self.page.id=user-name.or_(self.page.css=[placeholder='Username'])

    @property
    def password_input(self):
        """Input field for the password."""
        return self.page.id=password.or_(self.page.css=[placeholder='Password'])

    @property
    def login_button(self):
        """Button to submit the login form."""
        return self.page.id=login-button.or_(self.page.css=[name='login-button'])

    @property
    def accepted_usernames(self):
        """Text indicating the accepted usernames."""
        return self.page.xpath=//div[contains(text(),'Accepted usernames are:')].or_(self.page.text=Accepted usernames are:)

    @property
    def password_for_all_users(self):
        """Text indicating the password for all users."""
        return self.page.xpath=//div[contains(text(),'Password for all users:')].or_(self.page.text=Password for all users:)
