...
def take_screenshot(page, name):
    ...
    path = os.path.join('projects/train_target/screenshots', f'{name}.png')
...
def test_autonomous_flow(page: Page):
    ...
    # Generated for train_target
    page.goto("https://www.target.com/")
    smart_action(page, "scroll", "click", None)
    take_screenshot(page, "step_0")
    smart_action(page, "page.get_by_role(\"button\", name=\"Shop offer\")", "click", None)
    take_screenshot(page, "step_1")
    expect(page).to_have_url("https://www.target.com/pl/195374377?link=prz_top_deals_")
    smart_action(page, "page.locator('a[href=\"/\"]')", "click", None)
    take_screenshot(page, "step_2")
    expect(page).to_have_url("https://www.target.com/")
    smart_action(page, "scroll", "click", None)
