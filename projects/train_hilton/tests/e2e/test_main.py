...
def take_screenshot(page, name):
    ...
    path = os.path.join('projects/train_hilton/screenshots', f'{name}.png')
...
def test_autonomous_flow(page: Page):
    ...
    # Generated for train_hilton
    page.goto("https://www.hilton.com/en/")
    smart_action(page, "section.cp-content >> page.locator(\"a[href='https://www.hilton.com/en//']\")", "click", None)
    take_screenshot(page, "step_0")
    expect(page).to_have_url("https://www.hilton.com/en/")
    smart_action(page, "section.cp-content >> page.locator(\"a[href='https://www.hilton.com/en//']\")", "click", None)
    take_screenshot(page, "step_1")
    expect(page).to_have_url("https://www.hilton.com/en/")
    smart_action(page, "footer.inner-width >> page.locator(\"a[href='/']\")", "click", None)
    take_screenshot(page, "step_3")
    expect(page).to_have_url("https://www.hilton.com/en/")
    smart_action(page, "footer.inner-width >> page.locator(\"a[href='/']\")", "click", None)
    take_screenshot(page, "step_4")
    expect(page).to_have_url("https://www.hilton.com/en/")
    smart_action(page, "section.cp-content >> page.get_by_role(\"link\", name=\"GO BACK\")", "click", None)
    take_screenshot(page, "step_6")
    expect(page).to_have_url("https://www.hilton.com/en/")
    smart_action(page, "section.cp-content >> page.locator(\"a[href='https://www.hilton.com/en//']\")", "click", None)
    take_screenshot(page, "step_7")
    expect(page).to_have_url("https://www.hilton.com/en/")
    smart_action(page, "section.cp-content >> page.get_by_role(\"button\", name=\"GO BACK\")", "click", None)
