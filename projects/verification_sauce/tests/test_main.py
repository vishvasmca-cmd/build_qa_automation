...
class InventoryPage(BasePage):
    def __init__(self, page):
        super().__init__(page)
        self.add_to_cart_backpack_button = self.page.locator("[data-test='add-to-cart-sauce-labs-backpack']")
        self.add_to_cart_bolt_tshirt_button = self.page.locator("[data-test='add-to-cart-sauce-labs-bolt-t-shirt']")
