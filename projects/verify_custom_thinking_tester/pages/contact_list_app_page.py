...
class ContactListAppPage:
    """
    This page is the login page for the Contact List App. It allows existing users to log in with their email and password, and provides a link for new users to sign up.
    URL Pattern: https://thinking-tester-contact-list.herokuapp.com/login
    """
    ...
    def Sign Up Link(self):
        ...
        return self.page.role=link[name="Sign up"].or_(self.page.text=Sign up)
