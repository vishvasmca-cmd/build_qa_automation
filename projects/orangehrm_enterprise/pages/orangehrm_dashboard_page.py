...
class OrangehrmDashboardPage:
    """
    The Dashboard page of OrangeHRM provides a central overview of key information and quick actions for the user.
    ...
    def Dashboard Header(self):
        """The main header text on the Dashboard page."""
        return self.page.xpath=//h6[text()='Dashboard'].or_(self.page.css=h6.oxd-text--h6.oxd-topbar-header-breadcrumb-module)

    @property
    def Time at Work Card(self):
        """Container displaying the user's time at work information."""
    ...
    def Buzz Latest Posts Card(self):
        """Container displaying the latest posts from the Buzz module."""
    ...
    def Assign Leave Quick Launch(self):
        """Quick launch button to navigate to the Assign Leave page."""
    ...
    def Leave List Quick Launch(self):
        """Quick launch button to navigate to the Leave List page."""
    ...
    def Timesheets Quick Launch(self):
        """Quick launch button to navigate to the Timesheets page."""
    ...
    def Apply Leave Quick Launch(self):
        """Quick launch button to navigate to the Apply Leave page."""
    ...
    def My Leave Quick Launch(self):
        """Quick launch button to navigate to the My Leave page."""
    ...
    def My Timesheet Quick Launch(self):
        """Quick launch button to navigate to the My Timesheet page."""
    ...
    async def verify_loaded(self):
        ...
        await Dashboard header is displayed
        await Time at Work card is displayed
        await My Actions card is displayed
        await Quick Launch card is displayed
        await Buzz Latest Posts card is displayed