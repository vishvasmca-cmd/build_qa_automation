...
class UnknownPage:
    ...
    def user_role_dropdown(self):
        ...
        return self.page.get_by_text('-- Select --').first.or_(self.page.locator('div:has-text("User Role") >> .oxd-select-text'))
    ...
    def status_dropdown(self):
        ...
        return self.page.get_by_text('-- Select --').nth(1).or_(self.page.locator('div:has-text("Status") >> .oxd-select-text'))
