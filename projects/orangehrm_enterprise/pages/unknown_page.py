...
class UnknownPage:
    ...
    def username_input(self):
        ...
        return self.page.get_by_text('Username').locator('xpath=//input').or_(self.page.locator('div[class*="oxd-grid-item"]:nth-child(4) input'))

    @property
    def password_input(self):
        """Input field for password"""
        return self.page.get_by_text('Password').locator('xpath=//input').or_(self.page.locator('div[class*="oxd-grid-item"]:nth-child(5) input'))

    @property
    def confirm_password_input(self):
        """Input field to confirm password"""
        return self.page.get_by_text('Confirm Password').locator('xpath=//input').or_(self.page.locator('div[class*="oxd-grid-item"]:nth-child(6) input'))
