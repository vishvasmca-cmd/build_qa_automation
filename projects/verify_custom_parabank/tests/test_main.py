...
def test_minimal_smoke(browser: Browser):
    ...
    # 2. Navigate to site
    print(f"[Minimal Test] Navigating to https://parabank.parasoft.com/parabank/index.htm")
    ...
    assert "https://parabank.parasoft.com/parabank/index.htm" in current_url or page_title, \
    ...
    take_screenshot(page, "smoke_test_final", "verify_custom_parabank")
