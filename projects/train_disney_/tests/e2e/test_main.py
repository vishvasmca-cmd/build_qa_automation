...
def take_screenshot(page, name):
    ...
    path = os.path.join('projects/train_disney_/screenshots', f'{name}.png')
...
def test_autonomous_flow(page: Page):
    ...
    # Generated for train_disney_
    page.goto("https://www.disneyplus.com/")
    smart_action(page, "page.locator('section._9qq9r0').locator('a[href=\"/identity/sign-up?pref=disney_bundle_duo_basic\"]')", "click", None)
    take_screenshot(page, "step_0")
    expect(page).to_have_url("https://www.disneyplus.com/")
    smart_action(page, "scroll", "scroll", None)
    ...
    expect(page).to_have_url("https://www.disneyplus.com/")
    smart_action(page, "page.get_by_test_id('view_plans')", "click", None)
