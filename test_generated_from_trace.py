...
def take_screenshot(page, name):
    ...
    path = os.path.join('projects/projects/screenshots', f'{name}.png')
...
def test_autonomous_flow(page: Page):
    ...
    # Assert page content contains "Example Domain"
    expect(page.locator('body')).to_contain_text("Example Domain")

    # Assert that the link exists
    expect(page.locator('a', has_text='More information...')).to_be_visible()

    # Assert that the link href is "https://www.iana.org/domains/example" (corrected to example.com as needed)
    expect(page.locator('a', has_text='More information...')).to_have_attribute("href", "https://www.iana.org/domains/example")
